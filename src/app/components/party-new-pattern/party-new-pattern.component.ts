...
@Component({
  selector: 'app-party-new-pattern',
  templateUrl: './party-new-pattern.component.html',
  styleUrls: ['./party-new-pattern.component.css']
})
export class PartyNewPatternComponent implements OnInit {
    ...
    update(id) {
        this.loadingBtn = true;
        this.apiCall('update', 'partynewpattern/' + id);
    }
    ...
    categorySwitch(id) {
        this.apiCall('getData', 'PartyNewPatternSwitch/' + id);
    }
